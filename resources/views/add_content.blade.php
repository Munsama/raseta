...
@section('title')
<title>Raseta Admin|Add Content</title>
@endsection
          ...
          <div class="card card-danger">
            ...
            <div class="card-body">
              <div align="center">
                ...
                <div>
                    <img id="showcontent" class="img-fluid" style=" padding-top: 10px;  padding-bottom: 20px; width:50%; height:50%;">
                    <video  style="padding-top: 10px;  padding-bottom: 20px" width="50%" height="50%" autoplay controls>
                        <source id="showcontent">
                    </video>
                </div>
                <input required type="file" name="content" id="inputcontent" accept="image/jpg, image/png, image/jpeg, video/mp4" />
            </div>
        ...
        <div class="col-md-6">
          <div class="card card-danger">
            ...
            <div class="form-group">
                ...
                <input type="text" name="title" id="title" class="form-control" placeholder="e.g: Iklan New Year">
              </div>
              <div class="form-group">
